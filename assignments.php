...
<div class="container">
    <div class="left-panel">
        <div class="task-container">
            <div class="task-heading">Your Assignments</div>
            ...
            if(mysqli_num_rows($search_query) > 0){
                while ($newq = mysqli_fetch_assoc($search_query)) {
                    ...
                    echo '<div class="task-line">
                        <div class="div4"><li>'.$assignment_id.'</li></div>
                        <div class="div1">'.$assignment_name.'</div>
                        <div class="div4">
                            <button class="task-btn" onclick="window.location.href=\'edit-assignment.php?assignment='.$assignment_id.'\'">
    ...
    <div class="right-panel">
        ...
        <div class="menu">
            ...
            <div class="rightbar-buttons">
                ...
                <div class="rightbar-divider"></div>
                <button class="rightbar-button" onclick=window.location.href="create-assignment.php">Create New Assignment</button>
            </div>
        </div>
    </div>
</div>
